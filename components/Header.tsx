    ...
    return (
        <header className="flex flex-wrap justify-between items-center px-4 py-2">
            <div className="flex flex-wrap w-full justify-between items-center">
                <Link href="/"
                className={"text-2xl font-bold text-blue-500 hover:opacity-50 cursor-pointer mx-auto sm:mx-0"}>ShopwithGreen
                </Link>
                <Form
                action="/search"
                ...
                >
                    ...
                    className="bg-gray-100 text-gray-800 px-4 py-2 rounded focus:outline:none focus:ring-2 focus:ring-blue-500
